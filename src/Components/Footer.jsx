...
const Footer = () => {
  return (
    <>
    <footer id="footer" className="footer w-full flex flex-wrap justify-around p-10 bg-base-200 text-base-content">
    <div className="flex w-full  justify-end">
        <HashLink smooth={true} to="#Hero">
          <button className="btn btn-circle bg-base-200 ">
            <Icon path={mdiArrowUp} color="gray" size={1.5} className='animate-bounce' />
          </button>
        </HashLink>
      </div>
    <div className=" mb-10 lg:w-96 lg:pl-0  w-60">
                <div className="mb-6 flex items-center ">
                  <img
                    ...
                    className="w-20"
                  />
                  <p className='text-xl text-[#102C57] font-bold ml-1'>Bagguard</p>
                </div>
  ...
  <div>
    ...
    <div className="form-control w-full lg:w-80 ">
      ...
      <div>
        <input type="text" placeholder="Full Name" className="input input-bordered w-full pr-16" /> 
        <input type="email" placeholder="Your Email" className="input input-bordered w-full pr-16 my-2" /> 
        <textarea type="text" placeholder="Your Message" className="input input-bordered w-full pr-16" /> 
        <button
        type="button"
